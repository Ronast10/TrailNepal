...
const trails = [
...

  {
    ...
    category: 'trek',
    itinerary: [
      { day: 1, title: 'Kathmandu to Syabrubesi', elevation: '1,550m', hours: '6-7 hrs' },
      { day: 2, title: 'Syabrubesi to Lama Hotel', elevation: '2,470m', hours: '6-7 hrs' },
      { day: 3, title: 'Lama Hotel to Langtang Village', elevation: '3,430m', hours: '5-6 hrs' },
      { day: 4, title: 'Langtang Village to Kyanjin Gompa', elevation: '3,870m', hours: '3-4 hrs' },
      { day: 5, title: 'Acclimatization at Kyanjin (Hike Tserko Ri)', elevation: '4,984m', hours: '6-7 hrs' },
      { day: 6, title: 'Kyanjin to Lama Hotel', elevation: '2,470m', hours: '6-7 hrs' },
      { day: 7, title: 'Lama Hotel to Syabrubesi', elevation: '1,550m', hours: '5-6 hrs' },
    ],
    whatToBring: [
      'Warm layers',
      'Waterproof jacket',
...

  {
    ...
    category: 'trek',
    itinerary: [
      { day: 1, title: 'Drive Kathmandu to Tarkeghyang', elevation: '2,590m', hours: '7-8 hrs' },
      { day: 2, title: 'Tarkeghyang to Ama Yangri Peak and back', elevation: '3,771m', hours: '6-7 hrs' },
    ],
    whatToBring: [
      'Light jacket',
...

  {
    ...
    category: 'trek',
    itinerary: [
      { day: 1, title: 'Drive Kathmandu to Soti Khola', elevation: '700m', hours: '7-8 hrs' },
      { day: 2, title: 'Soti Khola to Machha Khola', elevation: '930m', hours: '6-7 hrs' },
      { day: 3, title: 'Machha Khola to Jagat', elevation: '1,340m', hours: '6-7 hrs' },
      { day: 4, title: 'Jagat to Deng', elevation: '1,860m', hours: '6-7 hrs' },
      { day: 5, title: 'Deng to Namrung', elevation: '2,630m', hours: '6-7 hrs' },
      { day: 6, title: 'Namrung to Lho', elevation: '3,180m', hours: '4-5 hrs' },
      { day: 7, title: 'Lho to Samagaun', elevation: '3,530m', hours: '4-5 hrs' },
      { day: 8, title: 'Acclimatization at Samagaun', elevation: '3,530m', hours: 'Rest Day' },
      { day: 9, title: 'Samagaun to Samdo', elevation: '3,860m', hours: '4-5 hrs' },
      { day: 10, title: 'Samdo to Dharamsala', elevation: '4,460m', hours: '4-5 hrs' },
      { day: 11, title: 'Cross Larke La Pass to Bimthang', elevation: '5,106m', hours: '8-10 hrs' },
      { day: 12, title: 'Bimthang to Dharapani', elevation: '1,860m', hours: '6-7 hrs' },
    ],
    whatToBring: [
      'Down jacket',
      'Thermal layers',
...

  {
    ...
    category: 'trek',
    itinerary: [
      { day: 1, title: 'Drive Kathmandu to Deurali', elevation: '2,200m', hours: '5-6 hrs' },
      { day: 2, title: 'Trek to Sailung Hill and return', elevation: '3,146m', hours: '4-5 hrs' },
    ],
    whatToBring: [
      'Light jacket',
      'Walking shoes',
